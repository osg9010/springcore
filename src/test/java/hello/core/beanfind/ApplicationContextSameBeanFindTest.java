...
public class ApplicationContextSameBeanFindTest {
    ...
    //LINE:: NoUniqueBeanDefinitionException
    @Test
    @DisplayName("타입으로만 빈 조회 시 같은 타입이 둘 이상 있으면 중복 오류가 발생한다")
    void findBeanByTypeeeDuplicate(){
    ...
    @Test
    @DisplayName("같은 타입이 둘 이상 있으면 이름과 타입 함께 지정하여 조회하면 된다.")
    void findBeanByName(){
